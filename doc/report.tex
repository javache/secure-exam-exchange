...
functionality. All communication with this webapplication will occur over HTTPS, as noted earlier.
...
of the exam and will generate a RSA-SHA256 signature of that file using the
default GnuPG keypair.
