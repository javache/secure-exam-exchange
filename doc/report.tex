...
\subsubsection{Attacks on the server}
...
Some things we consider so good practice for securing the server: Firewall to
drop all traffic not coming from a few white-listed locations.
