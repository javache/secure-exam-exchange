...
we need to make is that even the most secure exam system will fail if out-of-
band communication is possible: a system is only as strong as its weakest link.
