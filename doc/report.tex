...
Below we enumerate a few things we consider good practices for securing the
server: Firewall to drop all traffic not coming from a few white-listed
locations, setting up a fail2ban system which detects ssh login attempts and
blacklists the originating IP.
