...
\begin{itemize}
\item Impersonating the exam-server => Nope, HTTPS.
\item Man in the middle => Nope, HTTPS.
\item Replay-attacks => Nope, HTTPS.
...
server (give some general security ideas: automated banning, audit logs, ...)
