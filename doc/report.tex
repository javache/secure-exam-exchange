...
students from communicating during an exam or using cheat sheets. This indicates
that not only technology-related aspects influence how secure a system is:
practical measures also play an important role.

The conclusion we need to make is that even the most secure exam system will
fail if out-of-band communication is possible: a system is only as strong as its
weakest link.  More specifically in our case: \emph{PEBKAC}\footnotemark{}.

\footnotetext{\url{http://en.wikipedia.org/wiki/PEBKAC}}
