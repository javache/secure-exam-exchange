...
We would like to end this report with the words of a wise, mustachioed
man\footnote{http://www.youtube.com/watch?v=azEvfD4C6ow} \begin{quote}
  \textit{Asking students to design an exam system is like asking a miner to
  describe the bagger 288.} \end{quote}
